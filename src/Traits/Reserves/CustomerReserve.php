...
trait CustomerReserve
{
    ...
    public function reserve(ReservableInterface $reservable, DatetimeInterface|Carbon|DateTime $reserveDate, string $reserveTime = '00:00:00', ?array $metadata = null): Reserve | bool
    {
        ...
        {
            return $this->reserveWithCheckAvailability($reservable,$reserveDate,$reserveTime,$metadata);
        }

        return $this->doReserve($reservable,$reserveDate,$reserveTime,$metadata);
    }

    private function reserveWithCheckAvailability(ReservableInterface $reservable, DatetimeInterface|Carbon|DateTime $reserveDate, string $reserveTime = '00:00:00', ?array $metadata = null): Reserve | bool{
    ...
    private function doReserve(ReservableInterface $reservable, DatetimeInterface|Carbon|DateTime $reserveDate, string $reserveTime = '00:00:00', ?array $metadata = null):Reserve{
